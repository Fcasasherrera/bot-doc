...
class FillPermissionsForEnfermedad extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForEnfermedad constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.enfermedad',
            'admin.enfermedad.index',
            'admin.enfermedad.create',
            'admin.enfermedad.show',
            'admin.enfermedad.edit',
            'admin.enfermedad.delete',
            'admin.enfermedad.bulk-delete',
        ]);
