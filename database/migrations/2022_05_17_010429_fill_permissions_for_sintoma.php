...
class FillPermissionsForSintoma extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSintoma constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.sintoma',
            'admin.sintoma.index',
            'admin.sintoma.create',
            'admin.sintoma.show',
            'admin.sintoma.edit',
            'admin.sintoma.delete',
            'admin.sintoma.bulk-delete',
        ]);
