...
class FillPermissionsForPruebaLab extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPruebaLab constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.prueba-lab',
            'admin.prueba-lab.index',
            'admin.prueba-lab.create',
            'admin.prueba-lab.show',
            'admin.prueba-lab.edit',
            'admin.prueba-lab.delete',
            'admin.prueba-lab.bulk-delete',
        ]);
