...
class FillPermissionsForPruebaMortem extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPruebaMortem constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.prueba-mortem',
            'admin.prueba-mortem.index',
            'admin.prueba-mortem.create',
            'admin.prueba-mortem.show',
            'admin.prueba-mortem.edit',
            'admin.prueba-mortem.delete',
            'admin.prueba-mortem.bulk-delete',
        ]);
