...
class FillPermissionsForTratamiento extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTratamiento constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tratamiento',
            'admin.tratamiento.index',
            'admin.tratamiento.create',
            'admin.tratamiento.show',
            'admin.tratamiento.edit',
            'admin.tratamiento.delete',
            'admin.tratamiento.bulk-delete',
        ]);
