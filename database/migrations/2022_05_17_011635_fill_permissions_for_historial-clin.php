...
class FillPermissionsForHistorialClin extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForHistorialClin constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.historial-clin',
            'admin.historial-clin.index',
            'admin.historial-clin.create',
            'admin.historial-clin.show',
            'admin.historial-clin.edit',
            'admin.historial-clin.delete',
            'admin.historial-clin.bulk-delete',
        ]);
