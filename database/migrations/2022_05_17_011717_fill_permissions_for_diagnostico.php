...
class FillPermissionsForDiagnostico extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDiagnostico constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.diagnostico',
            'admin.diagnostico.index',
            'admin.diagnostico.create',
            'admin.diagnostico.show',
            'admin.diagnostico.edit',
            'admin.diagnostico.delete',
            'admin.diagnostico.bulk-delete',
        ]);
