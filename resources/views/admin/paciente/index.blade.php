                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'nombre'">{{ trans('admin.paciente.columns.nombre') }}</th>
                                        <th is='sortable' :column="'nss'">{{ trans('admin.paciente.columns.nss') }}</th>
                                        <th is='sortable' :column="'fechaNac'">{{ trans('admin.paciente.columns.fechaNac') }}</th>
